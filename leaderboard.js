...
async function getEmbed(c) {
	...
	.addFields(
        ...
        { name: '\u200B', value: '\u200B' },
		{ name: '🥈 : ' + await getName(top5Keys[1]), value: top5Values[1] + "   <:HentaiCoin:814968693981184030>", inline: true },
		{ name: '🥉 : ' + await getName(top5Keys[2]), value: top5Values[2] + "   <:HentaiCoin:814968693981184030>", inline: true },
        { name: '👍 : ' + await getName(top5Keys[3]), value: top5Values[3] + "   <:HentaiCoin:814968693981184030>", inline: true },
        { name: '\u200B', value: '\u200B' }
	)
